...
I kapitel \ref{sec:linux} er der en gennemgang af linux, dog mest i forhold til
...
Se Appendix \ref{linux_guide} for mere om brugen. Til at styre (de få)
...
curl -s https://raw.githubusercontent.com/Pilen/ubertex/master/linux/bspwmrc | tee.config/bspwmrc
\end{verbatim}
\begin{mdframed}[style=code]
  \verbatiminput{linux/bspwmrc}
\end{mdframed}
\begin{verbatim}
curl -s https://raw.githubusercontent.com/Pilen/ubertex/master/linux/sxhkdrc | tee .config/sxhkdrc
\end{verbatim}
\begin{mdframed}[style=code]
